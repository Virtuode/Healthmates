...
data class ActivityStats(
    ...
    companion object {
        ...
        const val CALORIES_PER_STEP = 0.04 // Average calories burned per step
        const val CARBON_SAVED_PER_KM = 0.2 // kg CO2 saved per km walked vs driving
        const val STEPS_PER_KM = 1312 // Average steps per kilometer
